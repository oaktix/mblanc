    ...
    <div className="flex flex-col lg:flex-row gap-16">
      <div className="w-full lg:w-2/3">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button 
            type="submit" 
            className="w-full py-5 bg-burgundy text-white font-semibold uppercase tracking-[0.2em] text-sm hover:bg-black transition-colors"
          >
            Complete Purchase ₦{getTotalPrice().toLocaleString()}
          </button>
        </form>
      </div>
